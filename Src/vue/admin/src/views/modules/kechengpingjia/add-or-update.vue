	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="教学目标" prop="jiaoxuemubiao">
					<el-select :disabled="ro.jiaoxuemubiao" v-model="ruleForm.jiaoxuemubiao" placeholder="请选择教学目标" >
						<el-option
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="教学目标" prop="jiaoxuemubiao">
					<el-input v-model="ruleForm.jiaoxuemubiao"
						placeholder="教学目标" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="教学方法" prop="jiaoxuefangfa">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="教学方法" prop="jiaoxuefangfa">
					<el-input v-model="ruleForm.jiaoxuefangfa"
						placeholder="教学方法" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="教学内容" prop="jiaoxueneirong">
					<el-select :disabled="ro.jiaoxueneirong" v-model="ruleForm.jiaoxueneirong" placeholder="请选择教学内容" >
						<el-option
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="教学内容" prop="jiaoxueneirong">
					<el-input v-model="ruleForm.jiaoxueneirong"
						placeholder="教学内容" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="教学效果" prop="jiaoxuexiaoguo">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="教学效果" prop="jiaoxuexiaoguo">
					<el-input v-model="ruleForm.jiaoxuexiaoguo"
						placeholder="教学效果" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="评价时间" prop="pingjiashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.pingjiashijian" label="评价时间" prop="pingjiashijian">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="textarea" v-if="type!='info'" label="评价建议" prop="pingjiajianyi">
					<el-input
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.pingjiajianyi" label="评价建议" prop="pingjiajianyi">
					<span :style='{"padding":"0 20px","color":"inherit","background":"#fff","display":"inline-block","width":"80%","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}'>{{ruleForm.pingjiajianyi}}</span>
				</el-form-item>
