	...
	<div class="list-container">
		...
		<div class="main-content">
			...
			<el-form :inline="true" :model="formSearch" class="search-form">
				...
				<el-button type="primary" class="search-btn" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>查询
				</el-button>
				<el-button v-if="btnAuth('kechengleixing', '新增')" class="add-btn" type="primary"
					@click="add('/index/kechengleixingAdd')">
