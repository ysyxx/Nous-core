		...
		<div class="breadcrumb-container">
			<el-breadcrumb separator="Ξ">
				...
				<el-breadcrumb-item v-for="(item, index) in breadcrumbItem" :key="index"
					to="/index/users"><a>{{ item.name }}</a></el-breadcrumb-item>
		...
		<div class="detail-container">
			<div class="detail-content">
				...
				<div class="detail-item">
					...
					<div class="item-value">{{ detail.role }}</div>
				</div>

				<div class="action-buttons">
					<el-button v-if="btnAuth('users', '修改')" class="edit-btn" @click="editClick">修改</el-button>
					<el-button v-if="btnAuth('users', '删除')" class="delete-btn" @click="delClick">删除</el-button>
				</div>
			</div>
