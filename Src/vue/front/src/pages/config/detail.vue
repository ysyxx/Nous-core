	...
	<div class="detail-container">
		...
		<div class="breadcrumb-section">
			<el-breadcrumb separator="Ξ">
				...
				<el-breadcrumb-item v-for="(item, index) in breadcrumbItem" :key="index" to="/index/config">
					{{ item.name }}
				</el-breadcrumb-item>
		...
		<div class="main-content">
			...
			<div class="attribute-section">
				<div class="info-section">
					...
					<div class="info-item">
						...
						<div class="item-value">{{ detail.name }}</div>
					</div>

					<div class="info-item">
						<div class="item-label">url</div>
						<div class="item-value">{{ detail.url }}</div>
					</div>

					<div class="action-buttons">
						<el-button v-if="btnAuth('config', '修改')" class="edit-btn" @click="editClick">
							修改
						</el-button>
						<el-button v-if="btnAuth('config', '删除')" class="delete-btn" @click="delClick">
							删除
						</el-button>
					</div>
				</div>
			...
			<!-- 右侧轮播图区域 -->
			<div v-if="detailBanner.length" class="banner-section">
				<div class="main-swiper">
					<div class="swiper-container">
						<div class="swiper-wrapper">
							<div class="swiper-slide" v-for="item in detailBanner" :key="item.id">
								<img :src="item.substr(0, 4) == 'http' ? item : baseUrl + item" class="banner-image"
									alt="详情图片">
							</div>
						</div>
