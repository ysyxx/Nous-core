<template>
	<div class="study-progress-detail">
		<div class="breadcrumb-container">
			<el-breadcrumb separator="Ξ">
				...
				<el-breadcrumb-item v-for="(item, index) in breadcrumbItem" :key="index"
					to="/index/xuexijindu"><a>{{ item.name }}</a></el-breadcrumb-item>
		...
		<div class="detail-container">
			<div class="detail-content">
				<div class="detail-header">
					<div class="header-title">{{ detail.kechengmingcheng }}</div>
				</div>
				...
				<div class="detail-item">
					...
					<div class="item-value">{{ detail.xuexishizhang }}</div>
				</div>

				<div class="detail-item">
					<div class="item-label">学习进度</div>
					<div class="item-value">{{ detail.xuexijindu }}</div>
				</div>

				<div class="detail-item">
					<div class="item-label">学习效果</div>
					<div class="item-value">{{ detail.xuexixiaoguo }}</div>
				</div>

				<div class="detail-item">
					<div class="item-label">已完成内容</div>
					<div class="item-value">{{ detail.yiwanchengneirong }}</div>
				</div>

				<div class="detail-item">
					<div class="item-label">未完成内容</div>
					<div class="item-value">{{ detail.weiwanchengneirong }}</div>
				</div>
				...
				<div class="action-buttons">
					<el-button v-if="btnAuth('xuexijindu', '修改')" class="edit-btn" @click="editClick">修改</el-button>
					<el-button v-if="btnAuth('xuexijindu', '删除')" class="delete-btn" @click="delClick">删除</el-button>
				</div>
			</div>
